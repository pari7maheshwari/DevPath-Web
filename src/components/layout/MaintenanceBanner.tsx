...
export default function MaintenanceBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[2000] h-[50px] bg-gradient-to-r from-orange-600/90 to-red-600/90 backdrop-blur-md border-b border-white/10 flex items-center justify-center px-4 shadow-lg text-white">
