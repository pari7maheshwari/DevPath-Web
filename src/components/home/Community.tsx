            ...
            <div className={styles.chatBody}>
              <div className={styles.message}>
                ...
                <div className={styles.messageContent}>
                  ...
                  <p className={styles.text}>
                    Just finished the Advanced React Patterns course! The
                    compound components section was a game changer. 🚀
                  </p>
                </div>
              </div>
              ...
              <div className={styles.message}>
                ...
                <div className={styles.messageContent}>
                  ...
                  <p className={styles.text}>
                    Congrats Sarah! I&apos;m working on the Node.js path right
                    now. Would love to see your final project.
                  </p>
                </div>
              </div>
              ...
              <div className={styles.message}>
                ...
                <div className={styles.messageContent}>
                  ...
                  <p className={styles.text}>
                    Anyone up for a code review? I just pushed some changes to
                    the open source dashboard project.
                  </p>
                </div>
              </div>
            </div>
