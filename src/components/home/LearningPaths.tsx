    ...
    <section className={styles.learningPaths}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>
          Follow expert-curated curriculums designed to take you from zero to
          mastery.
        </p>
      </div>
          ...
          >
            ...
            <div>
              <div className="flex justify-between items-center w-full mb-4">
                <span className={styles.badge} style={{ marginBottom: 0 }}>
                  {path.difficulty}
                </span>
                <ShareButton
            ...
            <div className={styles.footer}>
              <div className={styles.students}>
                ...
                <span className={styles.studentCount}>
                  +{path.students.toLocaleString()} enrolled
                </span>
              </div>
            ...
            {!isSubmitted ? (
              <>
                ...
                <p className={styles.modalText}>
                  We&apos;re crafting an amazing curriculum for{' '}
                  <strong>{selectedPath}</strong>. Want to be notified when it
                  launches?
                </p>
                <form
