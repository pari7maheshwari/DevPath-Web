...
export default function SubmitWizard() {
  ...
  const [errors, setErrors] = useState<
    Partial<Record<keyof SubmitWizardFormData, string>> & { submit?: string }
  >({});
  ...
  const validateStep = (step: number): boolean => {
    ...
    if (step === 1) {
      if (!formData.frameworks.trim())
        newErrors.frameworks = 'Frameworks are required';
    }
          ...
          <div className={styles.formCard}>
            <div className={styles.success}>
              ...
              <p className={styles.subtitle}>
                Your project has been successfully submitted for review. It will
            ...
            <div className="space-y-6">
              <div className={styles.formGroup}>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange('primaryLanguage', e.target.value)
                  }
                >
              ...
              >
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p style={{ color: 'var(--text-secondary)' }}>
                      {formData.frameworks || 'Not provided'}
                    </p>
                  </div>
                  <div>
