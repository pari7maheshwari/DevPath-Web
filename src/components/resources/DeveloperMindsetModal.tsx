...
export function DeveloperMindsetModal({
  isOpen,
  onClose,
}: DeveloperMindsetModalProps) {
          ...
          <div className="p-6 md:p-8 space-y-12">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-foreground">
                  1. The Problem With Over-Dependence on AI Tools
                </h3>
              </div>
              <div className="pl-14 space-y-4 text-muted-foreground">
                <p>
                  AI tools such as ChatGPT are powerful, but over-reliance can
                  create several issues for developers:
                </p>
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    Developers may start{' '}
                    <strong className="text-foreground">
                      spending tokens instead of thinking
                    </strong>
                    .
                  </li>
                  <li>
                    ...
                    , since many AI-generated solutions look similar.
                  </li>
                  <li>
                    ...
                    for coding tasks, creating an{' '}
                    <strong className="text-foreground">
                      illusion of coding ability
                    </strong>
                    .
                  </li>
                </ul>
                <div className="mt-4 p-4 bg-primary/10 border border-primary/20 rounded-xl">
                  ...
                  <p>
                    AI can assist with coding, but it cannot replace engineering
                    thinking.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="pl-14 grid grid-cols-1 md:grid-cols-2 gap-6 text-muted-foreground">
                ...
                <div className="bg-primary/5 p-5 rounded-xl border border-primary/20">
                  <h4 className="text-lg font-semibold text-primary mb-3 flex items-center gap-2">
                    <Brain size={18} /> Engineering Focus
                  </h4>
                  <ul className="list-disc pl-5 space-y-1">
              ...
              <div className="pl-14 mt-6">
                <blockquote className="border-l-4 border-primary pl-4 italic text-foreground text-lg">
                  Instead of asking "What technology should I use?", engineers
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-foreground">
                  3. Problem Solving & Debugging Mindset
                </h3>
              </div>
              <div className="pl-14 space-y-4 text-muted-foreground">
                <p>
                  Strong developers focus on problem-solving ability rather than
                  just coding. Key components include problem decomposition,
                  root cause analysis, and logical reasoning.
                </p>
                <div className="p-4 bg-muted/30 rounded-xl border border-border mt-4">
                  <h4 className="font-semibold text-foreground mb-2">
                    A good engineer must be able to:
                  </h4>
                  <ul className="list-disc pl-5 space-y-1">
                ...
                <p className="font-medium text-foreground mt-4">
                  Debugging and problem-solving are far more valuable than
                  memorizing syntax or tutorials.
                </p>
              </div>
            </section>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-foreground">
                  4. Certifications, Projects & The AI Bubble
                </h3>
              </div>
              <div className="pl-14 space-y-4 text-muted-foreground">
                <p>
                  Many developers focus heavily on certifications, but they
                  often show theoretical knowledge, not real engineering
                  experience.
                </p>
                ...
                <p>
                  With the current AI hype, the AI bubble may reduce basic
                  coding barriers. Developers will still need strong
                  fundamentals: Problem decomposition, Debugging ability,
                  Curiosity, Product thinking, System design, and Ownership
                  mindset.
                </p>
              </div>
            </section>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-foreground">
                  5. Ownership, Failure & System Design
                </h3>
              </div>
              <div className="pl-14 space-y-6 text-muted-foreground">
                <div>
                  ...
                  <p className="mt-2">
                    Curiosity builds better systems. Strong engineers
                    demonstrate ownership—they think about the entire system,
                    care about product success, and improve solutions
                    proactively rather than just completing assigned tasks.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-foreground text-lg">
                    Failure → Investigation → Insight
                  </h4>
                  <p className="mt-2">
                    Instead of avoiding failure, engineers use it to gain a
                    better understanding, make better design decisions, and
                ...
                <div className="bg-muted/30 p-4 rounded-xl border border-border">
                  ...
                  <p className="mt-2">
                    Every decision has trade-offs: Speed vs Scalability,
                    Simplicity vs Flexibility, Development time vs Performance.
                    Strong engineers manage these effectively.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-foreground">
                  6. Hiring, Resumes & Interviews
                </h3>
              </div>
              <div className="pl-14 space-y-4 text-muted-foreground">
                <p>
                  <strong className="text-foreground">Skills</strong> help you
                  get shortlisted, but{' '}
                  <strong className="text-foreground">Problem Solving</strong>{' '}
                  helps you get hired.
                </p>
                <p>
                  Companies use ATS (Applicant Tracking Systems) that look for
                  internships, keywords, and stack. During interviews, GitHub
                  plays a major role to demonstrate real experience,
                  consistency, and ownership.
                </p>
                <div className="mt-4 p-4 bg-muted/30 rounded-xl border border-border">
                  <h4 className="font-semibold text-foreground mb-3">
                    Effective Portfolio/Interview Structure
                  </h4>
                ...
                <p className="mt-4">
                  <strong className="text-foreground">Weak Approach:</strong>{' '}
                  Listing technologies.{' '}
                  <strong className="text-foreground">Strong Approach:</strong>{' '}
                  Explain what challenge existed, how you approached it, why
                  specific decisions were made, and the impact created.
                </p>
              </div>
            </section>
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-primary/10 to-purple-500/10 rounded-xl border border-primary/20 text-center">
              ...
              <p className="text-muted-foreground mb-4 max-w-2xl mx-auto">
                Great engineers do not focus on writing code faster. They focus
                on understanding problems deeply, designing intelligent systems,
                making thoughtful technical decisions, and creating real-world
                impact.
              </p>
            </div>
          </div>
