...
const defaultFlags: Flag[] = [
  // Existing kept flags
  {
    ...
    description:
      'Enable the context-aware chat widget to help you with coding problems.',
    status: 'Beta',
    category: 'Features',
    enabled: false,
  },
  ...
  // New Flags
  {
    ...
    description:
      'End-to-end quantum-resistant cryptography for all data transmission.',
    status: 'Core',
    category: 'Core',
    enabled: false,
  },
  ...
  },
  {
    ...
    description:
      'Advanced AI that predicts your next function definition before you type.',
    status: 'Experimental',
    category: 'Features',
    enabled: false,
  },
  {
    ...
    description:
      'Decentralized P2P content delivery for zero-latency asset loading.',
    status: 'Core',
    category: 'Core',
    enabled: false,
  },
  {
    ...
    description:
      'Write complex code structures using natural language voice commands.',
    status: 'Experimental',
    category: 'Features',
    enabled: false,
  },
  {
    ...
    description:
      'Auto-translate code comments and documentation to your native language.',
    status: 'Experimental',
    category: 'Features',
    enabled: false,
  },
    ...
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <div className={styles.warningBanner}>
          ...
          <span>
            <strong>Warning:</strong> These features are experimental and
            unstable. Enabling them may cause unexpected behavior or visual
            glitches.
          </span>
        </div>
    ...
    <div className={styles.card}>
      <div className={styles.flagInfo}>
        <div className={styles.flagName}>
          {flag.name}
          <span
            className={`${styles.badge} ${styles[flag.status.toLowerCase()]}`}
          >
            {flag.status}
          </span>
        </div>
      ...
      <label className={styles.switch}>
        <input type="checkbox" checked={flag.enabled} onChange={onToggle} />
