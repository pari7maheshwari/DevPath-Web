      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-6 text-center">
            <h3 className="text-4xl font-bold text-cyan-400 mb-2">4.9★</h3>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-6 text-center">
            <h3 className="text-4xl font-bold text-cyan-400 mb-2">120+</h3>
        ...
        <div className="text-center mt-16">
          <p className="text-muted-foreground">
            Trusted by learners, contributors, and developers across the
            community.
          </p>
        </div>
      </div>
