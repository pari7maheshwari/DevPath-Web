    ...
    <main className="min-h-screen pt-24 pb-12 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="container px-4 mx-auto flex flex-col items-center text-center z-10">
        <div className="mb-8 relative group">
          ...
          <div
            className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-white/5 flex items-center justify-center"
        ...
        <h2 className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl">
          We value your feedback. Help us improve the community by sharing your
          thoughts or reporting any issues you've encountered.
        </h2>
