                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start gap-4">
                        <div>
                          <h3
                            className={`font-semibold text-lg ${!notif.read ? 'text-foreground' : 'text-muted-foreground'}`}
                          >
                            {notif.title}
                          </h3>
                      ...
                      <p
                        className={`mt-3 leading-relaxed ${!notif.read ? 'text-foreground' : 'text-muted-foreground'}`}
                      >
                        {notif.message}
                      </p>
                      ...
                      {notif.image && (
                        <div className="mt-4 rounded-lg overflow-hidden border border-border max-w-md relative aspect-video">
                          <Image
                            src={notif.image}
                            alt={`${notif.title} notification attachment`}
                            fill
